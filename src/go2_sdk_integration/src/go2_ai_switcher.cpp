...
public:
    ...
    called_switcher_(false)
    {
        ...
        state_suber = this->create_subscription<unitree_go::msg::SportModeState>(
            "lf/sportmodestate", 10, std::bind(&AISwitcherNode::state_callback, this, std::placeholders::_1));
...
private:
    ...
    void state_callback(unitree_go::msg::SportModeState::SharedPtr data)
    {
        ...
        {
            switch_to_AI();
            RCLCPP_INFO(this->get_logger(), "Calling AI switcher function!");
