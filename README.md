...
Also using the name of the connection, you will have to set it as the parameter in the launch files. For basic deployment example you will only have to update `go2_rl_ws/src/go2_launch/launch/go2_walk_nodes_onnx.launch.py`. Again, using enp114s0 as an example:
```bash
